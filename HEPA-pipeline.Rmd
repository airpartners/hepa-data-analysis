...
# TODO figure out how to get x labels on graph
df_opc_bins <- df_sensor_sn[, c("timestamp",
                                "ratio_opc_bin0",
                                "ratio_opc_bin1",
                                "ratio_opc_bin2",
                                "ratio_opc_bin3",
                                ...
                                "ratio_opc_bin22",
                                "ratio_opc_bin23")]
df_opc_bins[is.na(df_opc_bins)] <- 0
df_opc_bins <- 
  melt(df_opc_bins, id = c("timestamp"), value.name = "concentrations")
df_opc_bins <- df_opc_bins %>% mutate(time = cut(timestamp, "hours"))
df_opc_bins %>%
